...
const Footer = (): JSX.Element => {
  return (
    <footer className='flex text-gray-300 h-36 sm:h-24'>
      <div className='container flex flex-col items-center justify-center px-8 py-8 mx-auto space-y-4 text-sm sm:space-y-0 sm:justify-between sm:py-0 sm:flex-row'>
        <div>© {new Date().getFullYear()} deepfried.io</div>
        <div className='flex items-center space-x-3'>
          <a href='https://deepfried.io/twitter' rel='noopener' target='_blank'>
            <svg
              fill='currentColor'
          ...
          <a href='https://deepfried.io/discord' rel='noopener' target='_blank'>
            <svg
              fill='currentColor'
              viewBox='0 0 71 55'
